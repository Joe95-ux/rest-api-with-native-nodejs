...
workers.validateCheckData = function (originalCheckData) {
  ...
  if (
    ...
    originalCheckData.timeoutSeconds
      ...
      debug("Error: One of the ckecks is not properly formatted. Skipping it.")
  }
};

//Perform the ckeck, send the originalcheckdata and the outcome of the check process to the next step in the process
...
workers.performCheck = function(originalCheckData){
    ...
    const path = parsedUrl.path; // using path and not "pathname" becasue we want the query sting
...
// Process the checkoutcome and update the checkdata as needed, and trigger an alert to the user if needed
...
// Alert user as to the change in their check status
workers.alertUserToStatusChange = function(newCheckData){
    ...
    helpers.sendTwilioSms(newCheckData.userPhone,msg,function(err){
        if(!err){
            ...
            debug("Error: Could not send an sms alert to user who had a state change in their check ");
